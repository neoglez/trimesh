...
|CircleCI| |Join the chat at https://gitter.im/trimsh/Lobby|
...
To install ``trimesh`` with all the soft dependencies which install
cleanly on Windows, Linux, and OSX using ``pip``:
...
-  `pyrender <https://github.com/mmatl/pyrender>`__ Render scenes using
   nice looking PBR materials
...
Quick recommendation: ``GLB`` or ``STL``. Every time you replace ``OBJ``
